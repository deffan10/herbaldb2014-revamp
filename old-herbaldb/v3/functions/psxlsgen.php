...
if( !defined( "PHP_SIMPLE_XLS_GEN" ) ) {
   ...
   class  PhpSimpleXlsGen {
     ...
     function FileName($report,$start,$end) {
        $tmp = 'report-'.$report.'('.$start.'_to_'.$end.')';
        $this->filename = $tmp;       // save filename
     }
     // Default constructor
     ...
     function Header( $text="" ) {
         /*
            if ( $text == "" ) {
               $text = "This file was generated using CallCenter Apps at ".date("d M Y");
            }
        */
        if ( $this->totalcol < 1 ) {
          $this->totalcol = 1;
